...
public class RandomBrickSound : MonoBehaviour
{
    [SerializeField] private AudioClip[] brickSounds;
    ...
    private void Awake()
    {
        ...
        if (audioSource == null)
        {
            ...
            Debug.Log("brickAudio source added to prefab");
        }
        else
        {
            Debug.Log("brickAudio source found on prefab");
        }
    ...
    public void RandomProjectileSound()
    {
        ...
        AudioClip clip = brickSounds[UnityEngine.Random.Range(0, brickSounds.Length)];
